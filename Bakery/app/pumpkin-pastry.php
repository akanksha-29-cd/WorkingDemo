					...
					<div class="col-md-6">
						<div class="product-details--img-gallery">
							<div class="img-gallery--big-img" id="big-img">
								<a href="Images/pumpkin-pastry.jpg"><img src="Images/pumpkin-pastry.jpg" alt="product-details" class="img-fluid"></a>
							</div>
							<div class="img-gallery--small-img" id="small-img">
								<a href="Images/pumpkin-pastry-1.jpg"><img src="Images/pumpkin-pastry-1.jpg" class="img-fluid"></a>
								<a href="Images/pumpkin-pastry-2.jpg"><img src="Images/pumpkin-pastry-2.jpg" class="img-fluid"></a>
								<a href="Images/pumpkin-pastry-3.jpg"><img src="Images/pumpkin-pastry-3.jpg" class="img-fluid"></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="product-details-page-desc">
							<h2>Pumpkin Pastry</h2>
							<p>$120.00</p>
							<p></p>
